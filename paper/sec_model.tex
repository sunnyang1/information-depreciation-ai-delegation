...
The assumption that the base preservation rate is uniform across layers and signals (conditional on $\bar{\alpha}_\ell$) is a simplification; we discuss heterogeneous depreciation in Section \ref{sec:extensions}.
