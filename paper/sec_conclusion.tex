...
\item \textbf{Endogenous architectures.} We take the chain structure as given. A fully general model would jointly optimize over chains, trees, and more complex graphs, as sketched in Section~\ref{subsec:trees}.
